...
export function ProductCardAdmin({ product, onEdit, onDelete, onView }: ProductCardAdminProps) {
  ...
  return (
    <motion.div
      ...
      className="bg-white rounded-2xl border border-gray-200 overflow-hidden group relative hover:border-gray-300 hover:shadow-md transition-all duration-300"
    >
      {/* Image Section */}
      <div className="relative h-48 bg-gray-100 overflow-hidden">
        ...
        {/* Hover Overlay */}
        <div className={`absolute inset-0 bg-black/40 backdrop-blur-sm flex items-center justify-center gap-3 transition-opacity duration-300 ${
      ...
      <div className="p-5">
        <div className="flex items-start justify-between mb-3">
          <div className="flex-1 min-w-0">
            <h3 className="font-semibold text-black truncate text-lg">{product.name}</h3>
        ...
        {/* Price */}
        <div className="mb-4">
          <p className="text-2xl font-bold text-black">{formatCurrency(product.price)}</p>
        ...
        <div className="grid grid-cols-3 gap-3">
          <div className="bg-gray-50 rounded-xl p-3 text-center border border-gray-100">
            ...
            <p className="text-lg font-bold text-black">{product.total_sold}</p>
          ...
          <div className="bg-gray-50 rounded-xl p-3 text-center border border-gray-100">
            ...
            <p className="text-lg font-bold text-black">{product.order_count}</p>
          ...
          <div className="bg-gray-50 rounded-xl p-3 text-center border border-gray-100">
            ...
            <p className="text-lg font-bold text-black">{product.quantity}</p>
    ...
    <div className="bg-white rounded-2xl p-6 border border-gray-200">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        <div className="bg-gray-50 rounded-xl p-4 border border-gray-100">
          ...
          <p className="text-2xl font-bold text-black">{product.total_sold}</p>
        </div>
        <div className="bg-gray-50 rounded-xl p-4 border border-gray-100">
          <div className="flex items-center gap-2 text-black mb-2">
          ...
          <p className="text-2xl font-bold text-black">{formatCurrency(product.total_revenue)}</p>
        </div>
        <div className="bg-gray-50 rounded-xl p-4 border border-gray-100">
          <div className="flex items-center gap-2 text-black mb-2">
          ...
          <p className="text-2xl font-bold text-black">{product.order_count}</p>
        </div>
        <div className="bg-gray-50 rounded-xl p-4 border border-gray-100">
          <div className="flex items-center gap-2 text-black mb-2">
          ...
          <p className="text-2xl font-bold text-black">{product.quantity}</p>
        </div>
      </div>

      <div className="mt-6 pt-6 border-t border-gray-100">
        <h4 className="font-medium text-black mb-4">Rendimiento de Ventas</h4>
            ...
            {Array.from({ length: 7 }).map((_, i) => {
              ...
              return (
                <motion.div
                  ...
                  className="flex-1 bg-gradient-to-t from-black to-gray-500 rounded-t-lg opacity-80 hover:opacity-100 transition-opacity cursor-pointer"
                />
              );
            })}
          </div>
